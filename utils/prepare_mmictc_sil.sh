...
echo "preparing $lang/T.fst"
get_token_fst_mmictc.py $lang/phones.txt no_blk |\
...
echo "preparing $lang/k2/T.fst"
get_token_fst_mmictc_k2.py $lang/k2/phones.txt no_blk |\
    fstcompile --isymbols=$lang/k2/tokens.txt --osymbols=$lang/k2/phones.txt |\
    fstarcsort --sort_type=olabel > $lang/k2/T.fst || exit 1;
