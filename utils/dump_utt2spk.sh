...
# Modified by University of Edinburgh (Zeyu Zhao) 2023 with utt2spk support
...
help_message="Usage: $0 <datadir> <logdir> <dumpdir>"
...
scp=$datadir/feats.scp
cmvnscp=$datadir/cmvn.scp
utt2spk=$datadir/utt2spk
...
if ${do_delta}; then
    ${cmd} JOB=1:${nj} ${logdir}/dump_feature.JOB.log \
        apply-cmvn --norm-vars=true --utt2spk=ark:${utt2spk} scp:${cmvnscp} scp:${logdir}/feats.JOB.scp ark:- \| \
        add-deltas ark:- ark:- \| \
