...
# usage: prepare_2state_sil3.sh data/lang

lang=$1

mkdir -p $lang/k2

(echo "<eps>"; echo "<SIL>_0"; echo "<SIL>_1"; echo "<SIL>_2"; \
...
get_token_fst_2state_sil3.py $lang/phones.txt |\
...
get_token_fst_2state_k2_sil3.py $lang/k2/phones.txt |\
