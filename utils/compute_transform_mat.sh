...
# Compute transform_mat of CTC for a data dir
# Usage: compute_transform_mat.sh --nj num_job data_dir lang_dir
# e.g, compute_transform_mat.sh --nj 10 data/train data/lang 
